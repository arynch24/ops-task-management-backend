...
-- CreateIndex
CREATE UNIQUE INDEX "recurring_task_schedules_assignmentId_key" ON "public"."recurring_task_schedules"("assignmentId");
...
-- CreateIndex
CREATE UNIQUE INDEX "task_assignments_scheduleId_key" ON "public"."task_assignments"("scheduleId");
...
-- AddForeignKey
ALTER TABLE "public"."recurring_task_schedules" ADD CONSTRAINT "recurring_task_schedules_assignmentId_fkey" FOREIGN KEY ("assignmentId") REFERENCES "public"."task_assignments"("id") ON DELETE SET NULL ON UPDATE CASCADE;
